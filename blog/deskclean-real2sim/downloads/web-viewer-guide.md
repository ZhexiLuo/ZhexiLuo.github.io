...
Download [the viewer source](https://zhexiluo.github.io/blog/deskclean-real2sim/downloads/web-viewer-source.zip) and [the original Blender scene](https://zhexiluo.github.io/blog/deskclean-real2sim/downloads/scene.blend). The source package contains the export script, viewer controls, a minimal HTML page, and a local copy of `@google/model-viewer` 4.3.1 with its license and package provenance.
...
The physics reproduction package is distributed separately as [reproduce.zip](https://zhexiluo.github.io/blog/deskclean-real2sim/downloads/reproduce.zip). It contains the original control rollout, contact evidence, simulation source, and renderer pipeline.
